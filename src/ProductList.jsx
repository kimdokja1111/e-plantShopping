...
// مهم: نتأكد إن CartSlice فيه addItem
...
function ProductList({ onHomeClick }) {
  ...
  // حالة الأزرار اللي تم إضافتها للسلة
  const [addedToCart, setAddedToCart] = useState({});

  const dispatch = useDispatch();

  // نجيب عناصر السلة عشان نعرض عددها على الأيقونة
  ...
  const handleAddToCart = (plant) => {
    ...
    // نحدث حالة الزر عشان يتغير إلى "Added to Cart"
    setAddedToCart({
      ...addedToCart,
      [plant.name]: true,
    });
